...
const NoteSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {r'ContentBlock': ContentBlockSchema},
  getId: _noteGetId,
...
int _noteEstimateSize(
  ...
  {
    final offsets = allOffsets[ContentBlock]!;
    for (var i = 0; i < object.blocks.length; i++) {
      final value = object.blocks[i];
      bytesCount += ContentBlockSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  {
...
void _noteSerialize(
  ...
  writer.writeObjectList<ContentBlock>(
    offsets[0],
    allOffsets,
    ContentBlockSchema.serialize,
    object.blocks,
  );
...
Note _noteDeserialize(
  ...
  final object = Note();
  object.blocks = reader.readObjectList<ContentBlock>(
        offsets[0],
        ContentBlockSchema.deserialize,
        allOffsets,
        ContentBlock(),
      ) ??
      [];
...
P _noteDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<ContentBlock>(
            offset,
            ContentBlockSchema.deserialize,
            allOffsets,
            ContentBlock(),
...
extension NoteQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> tagsEqualTo(List<String> tags) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'tags',
        value: [tags],
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> tagsNotEqualTo(
      List<String> tags) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'blocks',
        0,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'blocks',
        0,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQueryObject on QueryBuilder<Note, Note, QFilterCondition> {
  QueryBuilder<Note, Note, QAfterFilterCondition> blocksElement(
      FilterQuery<ContentBlock> q) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, List<ContentBlock>, QQueryOperations> blocksProperty() {
    return QueryBuilder.apply(this, (query) {
...
const _ContentBlocktypeEnumValueMap = {
...
const _ContentBlocktypeValueEnumMap = {
  r'paragraph': BlockType.paragraph,
  r'heading1': BlockType.heading1,
  r'heading2': BlockType.heading2,
  r'todo': BlockType.todo,
  r'bullet': BlockType.bullet,
  r'image': BlockType.image,
  r'video': BlockType.video,
};
...
extension ContentBlockQueryFilter
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeEqualTo(
    BlockType value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeLessThan(
    BlockType value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeBetween(
    BlockType lower,
    BlockType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ContentBlock, ContentBlock, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
