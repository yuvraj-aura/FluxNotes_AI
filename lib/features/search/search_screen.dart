    ...
    return Column(
      children: [
        ...
        Wrap(
          ...
          children: [
            _buildSuggestionChip("Summarize Meetings", Icons.bolt, primary,
                () => _askAI(allNotes, "Summarize my meetings")),
            _buildSuggestionChip("Project Status", Icons.folder_open, primary,
                () => _askAI(allNotes, "Status of Project on which I'm currently working")),
